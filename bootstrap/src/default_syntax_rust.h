static constexpr const char* DEFAULT_SYNTAX_RUST =
    ...
    "re2c:YYCONDTYPE = (.storable_state ? \"isize\" : \"usize\");\n"
    ...
    "re2c:YYPEEK = (.api.generic ? \"YYPEEK\" : \"get_unchecked\");\n"
    ...
    "re2c:tags:negative = (.api.generic ? \"@@\" : \"usize::MAX\");\n"
    "re2c:cond:divider = \"\";\n"
    "re2c:cond:goto = \"\";\n"
    "\n"
    "\n"
