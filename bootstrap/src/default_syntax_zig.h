static constexpr const char* DEFAULT_SYNTAX_ZIG =
    ...
    "re2c:yych:literals = hex; // zig does not recognize '\\f' escape sequence => use hex\n"
    ...
    "re2c:indent:string = \"    \";\n"
    "re2c:indent:top = 0;\n"
    "re2c:label:prefix = \"yy\"; // used to generate function names\n"
    "re2c:label:yyfill = \"\";\n"
    ...
    "re2c:tags:negative = (.api.generic ? \"@@\" : \"std.math.maxInt(usize)\");\n"
    "re2c:cond:divider = \"/* *********************************** */\";\n"
    ...
    "// code templates --------------------------------------------------------------\n"
    "\n"
    "code:var_local = topindent \"var \" name \": \" type \" = \" (.init ? init : \"0\") \";\" nl;\n"
    ...
    "\n"
    "code:fingerprint =\n"
    "    \"// Generated by re2zig\" (.version ? \" \" version) (.date ? \" on \" date) nl;\n"
    "\n"
